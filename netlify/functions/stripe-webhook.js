...
// Checkout → 3 scuse → Email (Resend @colpamia.com) → WhatsApp (Twilio) → metadata PI
...
// Twilio WA (Body libero; se usi template passa a ContentSid/Variables)
...
// Resend Email (mittente @colpamia.com) + errore propagato
